...
class FeedFactory {
    ...
    accountFollowers(options) {
        return class_transformer_1.plainToClassFromExist(new feeds_1.AccountFollowersFeed(this.client), Object.assign({ id: options && typeof options !== 'object' ? options : this.client.state.cookieUserId }, (typeof options === 'object' ? options : undefined)));
    }
    accountFollowing(options) {
        return class_transformer_1.plainToClassFromExist(new feeds_1.AccountFollowingFeed(this.client), Object.assign({ id: options && typeof options !== 'object' ? options : this.client.state.cookieUserId }, (typeof options === 'object' ? options : undefined)));
    }
    news() {
